                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px"><a
                                                        href="{{$data["site_url"]}}" style="outline:none" tabindex="-1"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px"><a
                                                        href="{{$data["site_url"]}}" style="outline:none" tabindex="-1"
                                                        target="_blank"><img alt="Image of lock & key." class="big"
                                                ...
                                                <div style="font-family: Arial, sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
                                                            <span
                                                                style="font-size:30px;color:#2b303a;"><strong>{{$data["mail_title"]}}</strong></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 22.5px;">
                                                            <span
                                                                style="color:#808389;font-size:15px;">{{$data["mail_content"]}}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px"><a
                                                        href="{{$data["site_url"]}}" style="outline:none" tabindex="-1"
                                                        target="_blank"><img alt="Your logo. " class="big"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
                                                            <span style="color:#95979c;font-size:12px;">Your Logo Copyright © 2021</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
                                                            <span style="color:#95979c;font-size:12px;">Want to stop receiving these emails?</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
                                                            <span style="color:#95979c;font-size:12px;"> <a
                                                                    href="{{$data["site_url"]}}" rel="noopener"
